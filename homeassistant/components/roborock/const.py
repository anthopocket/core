...
V1_CLOUD_IN_CLEANING_INTERVAL = timedelta(seconds=120)
V1_CLOUD_NOT_CLEANING_INTERVAL = timedelta(minutes=60)
V1_LOCAL_IN_CLEANING_INTERVAL = timedelta(seconds=120)
V1_LOCAL_NOT_CLEANING_INTERVAL = timedelta(seconds=60)
